...
import { ExecutiveCard } from "../leadership/ExecutiveCard";
import { LeadershipPrinciples } from "../leadership/LeadershipPrinciples";

export const metadata = {
  title: "Team - Ashlaur Construction",
  description:
    "Meet the team behind Ashlaur Construction. Our people bring experience, craftsmanship, and accountability to every project.",
};
...
const executives: Executive[] = [
  ...
  },
  {
    ...
    title: "Compliance",
    category: "Executive",
    bio: "Provides administrative support, manages executive communications, coordinates scheduling, and ensures smooth internal operations.",
  ...
  },
  {
    ...
    title: "Architect",
    category: "Executive",
    bio: "Design-focused architect bringing vision and technical expertise to every project. Her architectural work ensures innovation, functionality, and aesthetic excellence across all scopes.",
...
export default function Team() {
  const teamMembers = executives.filter((e) => e.category === "Executive");
        ...
        <section className="relative overflow-hidden py-20 lg:py-28 bg-gradient-to-b from-gray-900 to-gray-800">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="space-y-6 text-white">
              <p className="text-sm font-semibold tracking-wide text-blue-400">TEAM</p>
              <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-[0.9] tracking-tighter">
                Team Rooted in Accountability.
              </h1>
              <p className="text-xl lg:text-2xl text-gray-300 max-w-4xl leading-relaxed">
                Meet the people who drive our projects forward. Our team brings together experience,
                craftsmanship, and a commitment to delivering quality construction on every job.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  Ashlaur&apos;s team is built on a foundation of accountability, safety, and partnership. Our staff doesn&apos;t simply manage projects—they shepherd them through every phase with precision, power, and performance.
                </p>
                <p>
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  Each member of our team carries a singular commitment: to deliver construction excellence that transforms vision into reality. They set the standard across every project.
                </p>
                <p>
                  This is a team shaped by decades of construction experience and a deep commitment to our industry, our partners, and our city.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 lg:py-28 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="mb-16 space-y-4">
              <p className="text-sm font-semibold tracking-wide text-blue-600 uppercase">Team</p>
              <h2 className="text-5xl sm:text-6xl font-black leading-[0.95] tracking-tighter text-gray-900">
                Meet the Team Behind Ashlaur Construction
              </h2>
        ...
        <section className="py-20 lg:py-28 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center space-y-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our team is committed to building long-term partnerships. Let&apos;s discuss how Ashlaur can serve your next project.
            </p>
            <a
              href="/contact"
